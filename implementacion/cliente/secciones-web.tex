        ...
        \item Zona privada de usuario
            ...
            \begin{itemize}
                ...
                \item Lector
                    ...
                    Esta parte de la web permite enlazar un lector con la cuenta de usuario. Para ello, explicado brevemente, se generan dos códigos de barras que deben ser escaneador por el lector en menos de una hora para que se efectue la sincronización.

                    \begin{figure}[H]
                        \centering
                        \includegraphics[keepaspectratio,width=0.6\textwidth]{alta_lector_codigo_barras.png}
