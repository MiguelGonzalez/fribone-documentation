...
\input{implementacion/servidor/configurando-sistema}

\input{implementacion/servidor/git-tests-travis-ci}

\input{implementacion/servidor/problematica-tets-codeigniter}

\input{implementacion/servidor/esquema-base-datos}

\input{implementacion/servidor/esquema-servidor}

\input{implementacion/servidor/vinculacion-lector}

\input{implementacion/servidor/generacion-codigo-barras}